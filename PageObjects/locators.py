class LoginLocators:
    ...
    PASSWORD_VALIDATION = (
        '//*[@text="Please enter at least 8 characters"]', 'xpath')
    USERNAME_VALIDATION = (
        '//*[@text="Please enter a valid email address"]', 'xpath')


class SignUpLocators:
    SIGNUP_BUTTON_TEXT = (
        '//android.widget.TextView[@text="Sign up"]', 'xpath')
    ...
    SIGNUP_BUTTON = (
        '//android.view.ViewGroup[@content-desc="button-SIGN UP"]/android.view.ViewGroup', 'xpath')
    SUCCESS_MESSAGE = ('android:id/alertTitle', 'id')
    CONFIRM_PASSWORD_VALIDATION = (
        '//android.widget.TextView[@text="Please enter the same password"]', 'xpath')
    PASSWORD_VALIDATION = (
        '//android.widget.TextView[@text="Please enter at least 8 characters"]', 'xpath')
    USERNAME_VALIDATION = (
        '//android.widget.TextView[@text="Please enter a valid email address"]', 'xpath')
